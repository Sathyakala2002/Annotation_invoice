...
# Specify the path to the training data JSON file
...
# Load manual annotations from the JSON file
with open(annotation_file, 'r') as file:
    manual_annotations = json.load(file)
...
output_file = "automatic_annotations.json"
...
output_file_combined = "combined_annotations.json"
with open(output_file_combined, 'w') as file:
    json.dump(combined_annotations, file)

print("Combined annotations saved to:", output_file_combined)
